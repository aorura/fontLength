...
static const char qt_meta_stringdata_FontDialog[] = {
    "FontDialog\0\0showFontWidth()\0"
};
...
const QMetaObjectExtraData FontDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FontDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FontDialog,
      qt_meta_data_FontDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FontDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FontDialog))
        return static_cast<void*>(const_cast< FontDialog*>(this));
    if (!strcmp(_clname, "Ui::FontDialog"))
        return static_cast< Ui::FontDialog*>(const_cast< FontDialog*>(this));
